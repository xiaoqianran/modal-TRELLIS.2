...
```bash
modal-trellis2 generate path/to/photo.png -o /tmp/mesh.glb --dry-run
modal-trellis2 web
```
...
```bash
modal-trellis2 prefetch
modal-trellis2 prefetch --status
```
...
```bash
modal-trellis2 deploy
modal-trellis2 health
```
...
```bash
modal-trellis2 health --gpu

modal-trellis2 verify-gpu-reuse path/to/photo.png \
  --count 3 \
  --confirm-cost
```
